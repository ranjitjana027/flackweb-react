        ...
        <div className="header">
            <div className="channel-info">
                ...
                <div className="channel-dp">
                    <CustomAvatar alt={`${typeof props.channel_info !== 'boolean' && props.channel_info.channel_name}`}
                                  src=''/>
                </div>
                ...
                <Tooltip title='See Details'>
                    <div className="channel-name" onClick={props.toggleChannelDetails}>
                        <div
                            className="channel-title"> {typeof props.channel_info !== 'boolean' && props.channel_info.channel_name} </div>
                        <div
                            className="channel-id"> {typeof props.channel_info !== 'boolean' && (`@${props.channel_info.channel_id}`)} </div>
                    </div>
                </Tooltip>
